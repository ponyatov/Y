...
\secrel{Виртуальная \lisp-машина}\secdown

\secrel{Внешнее и внутреннее представление программ на \bi}

\secrel{Символьные вычисления на списках}

\secrel{Объектное расширение}

\secrel{\lisp-машина и интерпретатор}
